...
// Source: github.com/thebartekbanach/imcaxy/pkg/filefetcher (interfaces: Fetcher)
...
func (m *MockFetcher) Fetch(arg0 context.Context, arg1 string, arg2 hub.DataStreamInput) error {
	m.ctrl.T.Helper()
